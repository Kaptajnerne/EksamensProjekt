...
# Run like this:
# docker run -it --rm --name alphasolutions --pid=host -p 8080:8080 -p 3306:3306 -e MYSQL_ROOT_PASSWORD=1234 alphasolutions
#
...
#   - `-e MYSQL_ROOT_PASSWORD=1234`: This environment variable sets the root password for MySQL 'root' is default.
